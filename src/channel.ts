 ...
 */
function channelMessagesV2(token: string, channelId: number, start: number): messagesDetails | errorMessage {
  const data = getData();
...
export { channelDetailsV1, channelJoinV1, channelInviteV1, channelMessagesV2 };
