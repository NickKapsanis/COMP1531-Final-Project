...
test('tests the case that authUserId is invalid', () => {
  ...
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const output = channelJoinV1('wrongUId', testCreatedChannel);
...
test('tests the case that channelId is invalid', () => {
  ...
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const output = channelJoinV1(rufusAuthId, 'wrongChannel');
  expect(output).toStrictEqual({ error: 'error' });
});
...
test('tests the case that the user is already a member of the channel', () => {
  ...
  const jamesAuthId = authRegisterV1('james@gmail.com', 'testPassword123', 'James', 'Brown').authUserId;
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const output = channelJoinV1(jamesAuthId, testCreatedChannel);
  expect(output).toStrictEqual({ error: 'error' });
});
...
test('tests the case that the channel is private and the user is not a global owner', () => {
  ...
  const jamesAuthId = authRegisterV1('james@gmail.com', 'testPassword123', 'James', 'Brown').authUserId;
  const rufusAuthId = authRegisterV1('rufus@gmail.com', 'testPassword123', 'Rufus', 'Green').authUserId;
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', false).channelId;
  const output = channelJoinV1(rufusAuthId, testCreatedChannel);
  expect(output).toStrictEqual({ error: 'error' });
});
...
test('tests the case that the channel is private and the user is a global owner', () => {
  ...
  const jamesAuthId = authRegisterV1('james@gmail.com', 'testPassword123', 'James', 'Brown').authUserId;
  const rufusAuthId = authRegisterV1('rufus@gmail.com', 'testPassword123', 'Rufus', 'Green').authUserId;
  const testCreatedChannel = channelsCreateV1(rufusAuthId, 'testChannel1', false).channelId;
  const output = channelJoinV1(jamesAuthId, testCreatedChannel);
...
test('tests the case of a success', () => {
  ...
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const output1 = channelJoinV1(rufusAuthId, testCreatedChannel);
  const output2 = channelJoinV1(alexAuthId, testCreatedChannel);
...
test('tests the case that user inviting does not exist', () => {
  ...
  const rufusAuthId = authRegisterV1('rufus@gmail.com', 'testPassword123', 'Rufus', 'Green').authUserId;
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const output = channelInviteV1('fakeUser', testCreatedChannel, getUId(rufusAuthId));
  expect(output).toStrictEqual({ error: 'error' });
});
...
test('tests the case user joining does not exist', () => {
  ...
  const rufusAuthId = authRegisterV1('rufus@gmail.com', 'testPassword123', 'Rufus', 'Green').authUserId;
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const output = channelInviteV1(jamesAuthId, testCreatedChannel, 'fakeUId');
  expect(output).toStrictEqual({ error: 'error' });
});
...
test('tests the case channel does not exist', () => {
  ...
  const rufusAuthId = authRegisterV1('rufus@gmail.com', 'testPassword123', 'Rufus', 'Green').authUserId;
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const output = channelInviteV1(jamesAuthId, 'fakeChannel', getUId(rufusAuthId));
  expect(output).toStrictEqual({ error: 'error' });
});
...
test('tests the case channel uId refers to an existing channel member', () => {
  ...
  const alexAuthId = authRegisterV1('alex@gmail.com', 'bigBrainPassword', 'Alex', 'John').authUserId;
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const joinAlex = channelJoinV1(alexAuthId, testCreatedChannel);
  const output = channelInviteV1(jamesAuthId, testCreatedChannel, getUId(alexAuthId));
  expect(output).toStrictEqual({ error: 'error' });
});
...
test('tests the case that the user inviting is not a member of the channel', () => {
  ...
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const output = channelInviteV1(alexAuthId, testCreatedChannel, getUId(rufusAuthId));
  expect(output).toStrictEqual({ error: 'error' });
});
...
test('tests the case that the user invites themself', () => {
  ...
  const rufusAuthId = authRegisterV1('rufus@gmail.com', 'testPassword123', 'Rufus', 'Green').authUserId;
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const output = channelInviteV1(rufusAuthId, testCreatedChannel, getUId(rufusAuthId));
  expect(output).toStrictEqual({ error: 'error' });
});
...
test('tests the successful case', () => {
  ...
  const rufusAuthId = authRegisterV1('rufus@gmail.com', 'testPassword123', 'Rufus', 'Green').authUserId;
  const testCreatedChannel = channelsCreateV1(jamesAuthId, 'testChannel1', true).channelId;
  const output = channelInviteV1(jamesAuthId, testCreatedChannel, getUId(rufusAuthId));
  expect(output).toStrictEqual({});
});
